...
[<img src="https://img.shields.io/github/contributors/Mariem-Ben-Salah/Decision-Tree-Recommendation-System?style=for-the-badge" alt="CONTRIBUTORS" />](https://github.com/Mariem-Ben-Salah/Decision-Tree-Recommendation-System/graphs/contributors) 
[<img src="https://img.shields.io/github/stars/Mariem-Ben-Salah/Decision-Tree-Recommendation-System?style=for-the-badge" alt="STARS" />](https://github.com/Mariem-Ben-Salah/Decision-Tree-Recommendation-System/stargazers) 
[<img src="https://img.shields.io/github/forks/Mariem-Ben-Salah/Decision-Tree-Recommendation-System?style=for-the-badge" alt="FORKS" />](https://github.com/Mariem-Ben-Salah/Decision-Tree-Recommendation-System/network/members) 
[<img src="https://img.shields.io/github/issues/Mariem-Ben-Salah/Decision-Tree-Recommendation-System?style=for-the-badge" alt="ISSUES" />](https://github.com/Mariem-Ben-Salah/Decision-Tree-Recommendation-System/issues)
...
```
css3_hex_to_names is a function that converts a hexadecimal color code to its corresponding CSS3 color name. 
For example, the function would convert the hexadecimal code #FF0000 to the CSS3 color name red. 

hex_to_rgb is a function that converts a hexadecimal color code to its corresponding RGB color values. 
For example, the function would convert the hexadecimal code #FF0000 to the RGB values 255, 0, 0.
```
